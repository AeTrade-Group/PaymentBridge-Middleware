...
public class PaymentController {
	 ...
	 * determines the appropriate gateway service based on the payment method, and
	 * processes the payment.
	 * 
	 * @param paymentRequest The payment request details from CS-Cart.
	 * @return ResponseEntity containing the PaymentResponse, including status and
	 *         message.
	 */
	...
	public ResponseEntity<PaymentResponse> initiatePayment(@RequestBody PaymentRequest paymentRequest) {
		...
		gatewayService.saveTransaction(paymentRequest, response);
	...
	/**
	 * Endpoint to handle asynchronous callbacks from the payment gateway. This
	 * method processes updates from the gateway about the payment status.
	 * 
	...
	public ResponseEntity<String> handlePaymentCallback(@RequestBody PaymentResponse paymentResponse) {
		// Assuming the paymentResponse includes enough information to determine the
		// gateway
		...
		// A method to process callbacks should be implemented in the GatewayService or
		// handled here
		try {
